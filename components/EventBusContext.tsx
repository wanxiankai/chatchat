...
import { createContext, Dispatch, ReactNode, SetStateAction, useCallback, useContext, useMemo, useReducer, useState } from "react"
...
type EventBusContextProps = {
    ...
    publish: (evetn: string, data?: any) => void
}
